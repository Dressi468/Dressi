...
export default function HowDressiWorks({ onBetaClick }: HowDressiWorksProps) {
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-b from-[#1a0013] via-black to-[#0c0210] py-16 sm:py-24 lg:py-28">
      ...
      <div className="mx-auto flex max-w-full flex-col gap-12 px-4 sm:gap-16 sm:px-8 lg:gap-20 lg:px-10">
        ...
        >
          <h2 className="text-3xl font-bold tracking-wide text-transparent bg-gradient-to-r from-pink-300 via-purple-400 to-pink-500 bg-clip-text sm:text-5xl lg:text-7xl leading-tight">
        ...
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <h3 className="mt-2 text-xl font-bold text-transparent bg-gradient-to-r from-pink-200 via-white to-purple-300 bg-clip-text tracking-tight leading-tight sm:text-3xl lg:text-4xl">
                  {step.title}
                </h3>
